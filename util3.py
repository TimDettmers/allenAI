...
class Util:
    ...
    def plot_error_bar_diagram(self,datasets, path, skip = 0, title=''):    
        plt.figure()
        
        plt.ylim([0,5])
        colors = ['black','blue','orange','green', 'red','brown', 'grey', 'gold','magenta']
        ecolors = ['black','blue','orange','green', 'green', 'red','yellow','grey', 'brown']
        #legend_entries = ['8-bit dynamic tree','32-bit',]
        #legend_entries = ['8-bit mantissa','8-bit dynamic','8-bit static','8-bit linear quant','32-bit']
        legend_entries = ['8-bit dynamic','8-bit linear quant','32-bit 4 layers','32bit 2 layers','32bit pre-softmax noise','linear quant 10 layers','32bit 10 layers']
